...
personnel_local = "http://192.168.74.105:8085"
toir_local = "http://192.168.74.96:1912"
...
SERVICES_LINKS = [
    ...
    "{}/PersonnelAPI/DataExchange/".format(personnel_ip),
    ...
    "{}/TOIRAPI/DataExchange/".format(toir_ip)
]
